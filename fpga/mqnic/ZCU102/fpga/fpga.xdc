...
set_property -dict {LOC AL8  IOSTANDARD DIFF_SSTL12} [get_ports clk_user_si570_p]
set_property -dict {LOC AL7  IOSTANDARD DIFF_SSTL12} [get_ports clk_user_si570_n]
